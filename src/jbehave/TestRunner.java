 ...
 * 
 * @author Kane.Sun
 * @version Feb 19, 2014 8:48:37 AM
 * 
 */
...
public class TestRunner extends JUnitStories {
	...
	private ICanToggleACell pages = new ICanToggleACell();
	...
	public InjectableStepsFactory stepsFactory() {
		...
		return new InstanceStepsFactory(configuration, new GridSteps(), lifecycleSteps, new WebDriverScreenshotOnFailure(driverProvider, configuration.storyReporterBuilder()));
	}
