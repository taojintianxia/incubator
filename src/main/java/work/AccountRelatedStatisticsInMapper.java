...
public class AccountRelatedStatisticsInMapper {
	...
	private static final List<String> FINANCE_RELATED_KEYWORD = Arrays.asList("cash", "frozenWithDrawCash",
			"frozenBiddingCash", "totalCreditLimit", "freeWithdrawQuota", "runUpAccount", "appointmentFrozenCash",
			"modifyTime", "datetime", "avaliableCreditLimit");
